<template>
    <div class="intro-text-inner">
        <h3>ExploSig provides interactive visualization and analysis of mutation signatures.</h3>
        <h4>Background</h4>
        <p>Mutation signatures are distinctive patterns of somatic mutations generated by different mutational processes over the course of a lifetime <CiteP code="alexandrov2013signatures"/>. 
        ...
        The concept of mutation signatures has been validated by in vitro experiments that perform knockouts of DNA repair genes and then observe that mutation signatures result <CiteP code="zou2018validating,nik2015genome"/>. 
        Many mutation signatures can be attributed to known causes or mutational processes, ranging from smoking to ultraviolet light exposure to defects in specific DNA repair pathways <CiteP code="alexandrov2016mutational,haradhvala2018distinct,helleday2014mechanisms"/>.
        Yet the origins of many other signatures remain open questions.
        
        <h4>Introduction</h4>
        ExploSig is a web-based tool that enables interactive exploration of mutation signatures, mutation data, and clinical data. 
        This tool allows users to choose sequencing project datasets by cancer type, as well as mutation signature combinations (which can be selected arbitrarily or based on cancer type) before plotting this data. 
        ...
        <p>
            To begin, select sample cohorts and mutation signatures of interest. 
